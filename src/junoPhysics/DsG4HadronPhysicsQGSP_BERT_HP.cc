...
// ********************************************************************
//
// $Id: DsG4HadronPhysicsQGSP_BERT_HP.cc 105736 2017-08-16 13:01:11Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   DsG4HadronPhysicsQGSP_BERT_HP
//
...
#include "DsG4NeutronPHPBuilder.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(DsG4HadronPhysicsQGSP_BERT_HP);

DsG4HadronPhysicsQGSP_BERT_HP::DsG4HadronPhysicsQGSP_BERT_HP(G4int)
    :  DsG4HadronPhysicsQGSP_BERT_HP("hInelastic QGSP_BERT_HP")
{}

DsG4HadronPhysicsQGSP_BERT_HP::DsG4HadronPhysicsQGSP_BERT_HP(const G4String& name, G4bool /*quasiElastic */ )
    :  G4HadronPhysicsQGSP_BERT(name)
{
    minBERT_neutron = 19.9*MeV;
}

void DsG4HadronPhysicsQGSP_BERT_HP::Neutron()
{
  ...
  neu->RegisterMe(bert);
  auto hp = new DsG4NeutronPHPBuilder;
...
void DsG4HadronPhysicsQGSP_BERT_HP::ExtraConfiguration()
{
  //Modify XS for kaons
