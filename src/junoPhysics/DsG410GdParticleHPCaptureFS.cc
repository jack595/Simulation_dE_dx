...
//                            
// Modified class from original G4ParticleHPCaptureFS class to deexcite and
...
G4HadFinalState * DsG410GdParticleHPCaptureFS::ApplyYourself(const G4HadProjectile & theTrack)
{
    G4int i;
...
void DsG410GdParticleHPCaptureFS::UpdateNucleus( const G4Fragment* gamma , G4double eGamma )
{
...
//void DsG410GdParticleHPCaptureFS::Init (G4double A, G4double Z, G4String & dirName, G4String & )
void DsG410GdParticleHPCaptureFS::Init (G4double A, G4double Z, G4int M, G4String & dirName, G4String &, G4ParticleDefinition*)
{
    G4String tString = "/FS/";
    G4bool dbool;
    G4ParticleHPDataUsed aFile = theNames.GetName(static_cast<G4int>(A), static_cast<G4int>(Z), dirName, tString, dbool);
